...
if __name__ == '__main__':
    ...
    parser.add_argument('--token_string', type=str, default="ta2kn")
    parser.add_argument('--caption_prefix', type=str, default="a photo of")
    parser.add_argument('--class_name', type=str, default="man")
    ...
    parser.add_argument('--use_face_detection_instead', type=bool, default=True)
