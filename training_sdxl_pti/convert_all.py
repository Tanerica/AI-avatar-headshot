...
local_weights_cache = '/workspace/output_cog/Ali/'
revision = None
...
handler.load_embeddings("/workspace/output_cog/Ali/embeddings.pti")
import torch
from safetensors.torch import save_file

# Assuming `text_encoder_one`, `text_encoder_two`, `vae`, `unet`, and `noise_scheduler`
# are the components of your model that you want to save.

# Access the updated embeddings from the text encoders
embeddings_one = text_encoder_one.get_input_embeddings().weight
embeddings_two = text_encoder_two.get_input_embeddings().weight
